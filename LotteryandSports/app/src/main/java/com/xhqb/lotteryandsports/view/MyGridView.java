package com.xhqb.lotteryandsports.view;
...
import com.xhqb.lotteryandsports.utils.DpAndPxUtil;
...
public class MyGridView extends GridView {
	...
	public MyGridView(Context context, AttributeSet attrs) {
		...
		pop.setWidth(DpAndPxUtil.dip2px(context, 55));// dip--px
		pop.setHeight(DpAndPxUtil.dip2px(context, 53));
	}
